...
export default function Login() {
  ...
  const handleGoogle = async () => {
    ...
    // On success Supabase redirects to /auth/callback — no navigate needed
  }
  ...
  return (
    <div className="min-h-screen relative bg-white">
      ...
      <div className="absolute top-[25%] left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-brand-violet/8 rounded-full blur-[200px] -z-10 pointer-events-none" />
      ...
      <div className="relative z-10">
        ...
        <main className="pt-32 pb-20 px-6 min-h-screen flex items-center">
          <div className="max-w-md mx-auto w-full">
            <div className="bg-white/70 backdrop-blur-md border border-gray-200/50 rounded-2xl p-8 shadow-xl shadow-black/5">
              {/* Header */}
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full py-3 bg-white border-2 border-gray-200 text-gray-700 font-semibold rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 flex items-center justify-center gap-3 shadow-sm cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? (
            ...
            <div className="mt-6 text-center">
              <button
                onClick={() => navigate(from === '/dashboard' ? '/' : from)}
